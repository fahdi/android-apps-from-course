    ...
    $.fn.ical = function(options){
        ...
        */
        function createNavigation(obj, insdate){
            obj.append("<div style='background: #6A80B1;padding: 7px 0;color: #fff;font-size: 15px;'><span id = 'currentmonth'>"+ options.monthnames[insdate.getMonth()] +"</span> <span id = 'currentyear'>"+ insdate.getFullYear() +"</span></div>" +
                      "<span id ='icalprev'><</span><span id ='icalnext'>></span>");
